...
def create_email_account(data):
	...
	try:
		...
		if service == "":
			email_doc.email_server = data.get("imap_server")
			email_doc.imap_server = data.get("imap_server")
			email_doc.imap_port = data.get("imap_port")
			email_doc.smtp_server = data.get("smtp_server")
			email_doc.smtp_port = data.get("smtp_port")
